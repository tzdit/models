...
type VehicleMaintenanceQuotationFull struct {
	Id						int	`json:"id,omitempty" form:"id" validate:"omitempty,numeric"`
	VehicleInspectionId    	string		`json:"vehicle_inspection_id,omitempty" form:"vehicle_inspection_id" validate:"omitempty,numeric"`
	VendorId    			string		`json:"vendor_id,omitempty" form:"vendor_id" validate:"omitempty,numeric"`
